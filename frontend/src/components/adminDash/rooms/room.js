...
export default function Roooom() {
						...
						<AccordionDetails>
							<TableContainer className={classes.top} component={Paper}>
								<Table className={classes.table} aria-label="simple table">
									...
									<TableCell align="left">Personne hospitalisé</TableCell>
								
									{room.patienthospitalise.map((patient) => (
										<TableRow>
											<TableCell align="left">
												<IconButton
													onClick={(e) => handleDeletePatient(e, room._id,patient._id,patient.firstname,indexRoom)}
													aria-label="delete"
												>
													<DeleteIcon />
												</IconButton>
