      ...
      <Table className={classes.table} aria-label="simple table">
        <TableHead>
          <TableRow>
            ...
            <TableCell align="left">Problème</TableCell>
            <TableCell align="left">Antécédants</TableCell>
          ...
          {patients.filter(item => {
            ...
            .map((patient, index) => (
              <TableRow key={patient.firstname}>
                ...
                <TableCell align="left">{patient.probleme}</TableCell>
                <TableCell align="left">{patient.antecedentDuPatient}</TableCell>
                <TableCell align="left">{patient.taille}</TableCell>
                <TableCell align="left">{patient.poids}</TableCell>
                <TableCell align="left">{patient.groupesang}</TableCell>
