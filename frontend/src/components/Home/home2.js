				...
				<div className="container">
					<div className="row">
						<div className="col-lg-6 col-md-12 col-sm-12 align-self-center mobile-bottom-fix">
							...
							<div className="left-text">
								<p>
									Cette application sera bien évidement améliorer pour rajouter de nouvelles fonctionnalitées
								</p>
							</div>
						</div>
						<div className="col-lg-1"></div>
						...
						<div className="row">
							<div className="col-lg-2 col-md-3 col-sm-6 col-6">
								<div className="mini-box">
									...
									<span>
										Toutes les données sont chiffrées <br /> et stocker <br /> sur nos propres
										serveurs pour une sécurité maximale.
									</span>
								</div>
							</div>
							...
							<div class="col-lg-2 col-md-3 col-sm-6 col-6">
								<div class="mini-box">
									...
									<span>
										Suivez en temps réel les dernières nouvelles de votre clinique et <br/> ayez un controle sur tout.
									</span>
								</div>
							</div>
							<div class="col-lg-2 col-md-3 col-sm-6 col-6">
					...
					<div className="row">
						...
						<div className="offset-lg-3 col-lg-6">
							<div className="center-text">
								<p>
									Ici vous pouvez essayer notre application pour vous faire une idée, choisissez
									simplement en tant que qui vous voulez l'essayer.
								</p>
							</div>
						</div>
					</div>
						...
						>
							<div className="pricing-item">
								...
								<div className="pricing-body">
									...
									<ul className="list">
										<li className="active">Essayer en tant que Patient</li>
									</ul>
								</div>
						...
						>
							<div className="pricing-item active">
								...
								<div className="pricing-body">
									...
									<ul className="list">
										<li className="active">Essayer en tant qu'Administrateur ( secretariat )</li>
									</ul>
								</div>
								<div className="pricing-footer">
					...
					<div className="row">
						...
						<div className="col-lg-4 col-md-6 col-sm-12">
							...
							<div className="contact-text">
								<p>
									Prenez rendez-vous avec un medecin
									<br />
									Remplissez les informations correctements
									<br />
